...
f(0)
{
	...
	//VIEW MATRIX
	//vue de l'axe des z
	_viewMatrix = glm::lookAt(glm::vec3(3, 5, 8), glm::vec3(0, 1.5, 0), glm::vec3(0, 1, 0));
	...
	wheel_fl_initial_translation = glm::translate(glm::mat4(), glm::vec3(0.4, 0.3, 0.55));
	wheel_fr_initial_translation = glm::translate(glm::mat4(), glm::vec3(0.4, 0.3, -0.55));
	wheel_rl_initial_translation = glm::translate(glm::mat4(), glm::vec3(-0.4, 0.3, 0.55));
	wheel_rr_initial_translation = glm::translate(glm::mat4(), glm::vec3(-0.4, 0.3, -0.55));
	...
	body.ReInit(body_initial_shear);
	scissor1.ReInit(scissors_initial_shear);
	scissor2.ReInit(glm::inverse(scissors_initial_shear));
	

	
	//wheel_fr.Init(wheels_initial_rotation);
	/*wheel_fl.Init(glm::inverse(body_initial_translation)*
...
void CoreTP1::Render(double dt) //dt is the time unit
{
	...
	//}
	//BOUNDING BOX COORDS RESET
	dynamite_body.Reset_coords();
	body.Reset_coords();
